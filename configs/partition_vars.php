...
$part1TotalC = "df -h | grep $partition1 | awk '{print $1}'";
$part1UsedC = "df -h | grep $partition1 | awk '{print $2}'";
$part1FreeC = "df -h | grep $partition1 | awk '{print $3}'";
$part2TotalC = "df -h | grep $partition2 | awk '{print $1}'";
$part2UsedC = "df -h | grep $partition2 | awk '{print $2}'";
$part2FreeC = "df -h | grep $partition2 | awk '{print $3}'";
$part3TotalC = "df -h | grep $partition3 | awk '{print $1}'";
$part3UsedC = "df -h | grep $partition3 | awk '{print $2}'";
$part3FreeC = "df -h | grep $partition3 | awk '{print $3}'";
$part4TotalC = "df -h | grep $partition4 | awk '{print $1}'";
$part4UsedC = "df -h | grep $partition4 | awk '{print $2}'";
$part4FreeC = "df -h | grep $partition4 | awk '{print $3}'";
