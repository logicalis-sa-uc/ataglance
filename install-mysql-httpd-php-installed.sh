...
# Add the crontabs
(crontab -l ; echo "* * * * * /var/www/html/ataglance/getinfo.sh") | crontab -
(crontab -l ; echo "* * * * * /var/www/html/ataglance/ataglanceServer.sh") | crontab -
(crontab -l ; echo "* * * * * /var/www/html/ataglance/ataglanceAsterisk.sh") | crontab -