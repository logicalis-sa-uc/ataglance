...
require_once "../configs/motion_vars.php";
?>
<!DOCTYPE html>
<html>
<head>
<title>LSA @ A GLANCE | MOTION</title>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<script src="../scripts/sidebar.js"></script>
<script src="../scripts/motion_buttons.js"></script>
</head>
...
<nav class="w3-sidebar w3-collapse w3-animate-left" style="z-index:3;width:300px; background-color: <?php echo $bgColor; ?>; color: <?php echo $txtColor; ?>;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="motion.php" class="w3-bar-item w3-button w3-padding w3-red"<?php if ($motionEnabled != 1) echo ' style="display: none;"'; ?>><i class="fa fa-window-restore fa-fw"></i> Motion</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h3><b><i class="fa fa-dashboard"></i> LSA MOTION</b></h3>
  </header>
<hr>
  <div class="w3-panel">
    ...
    <h3>RUN COMMANDS</h3>
        ...
        <button type="button" onclick="confirmReload('NODEJS');" class="w3-black" style="width:200px; border-radius: 10px; cursor: pointer; border:none; padding:10px; margin-left:5px; margin-right:5px;">Reload NODEJS</button>
    </div>
  </div>
    <hr>
  <!-- ASTERISK INFO -->
  ...
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
        ...
        <p>
	<?php
		if (isset($motionOutLines)) {
		  foreach ($motionOutLines as $motionLine) {
                  echo "<p>$motionLine</p>";
            	  }
        	}
	?>
