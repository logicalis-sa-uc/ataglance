...
require_once "../configs/queuemetrics_vars.php";
?>
<!DOCTYPE html>
<html>
<head>
<title>LSA @ A GLANCE | QUEUEMETRICS</title>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<script src="../scripts/sidebar.js"></script>
<script src="../scripts/queuemetrics_buttons.js"></script>
</head>
...
<nav class="w3-sidebar w3-collapse w3-animate-left" style="z-index:3;width:300px; background-color: <?php echo $bgColor; ?>; color: <?php echo $txtColor; ?>;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="queuemetrics.php" class="w3-bar-item w3-button w3-padding w3-red"<?php if ($queuemetricsEnabled != 1) echo ' style="display: none;"'; ?>><i class="fa fa-users fa-fw"></i> Queuemetrics</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h3><b><i class="fa fa-dashboard"></i> LSA QUEUEMETRICS</b></h3>
  </header>
<hr>
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
    <h3>RUN COMMANDS</h3>
        <button type="button" onclick="confirmReload('QUEUEMETRICS');" class="w3-black" style="width:200px; border-radius: 10px; cursor: pointer; border:none; padding:10px; margin-left:5px; margin-right:5px;">Reload QUEUEMETRICS</button>
        <button type="button" onclick="confirmReload('QLOADER');" class="w3-black" style="width:200px; border-radius: 10px; cursor: pointer; border:none; padding:10px; margin-left:5px; margin-right:5px;">Reload QLOADER</button>
        <button type="button" onclick="confirmReload('UNILOADER');" class="w3-black" style="width:200px; border-radius: 10px; cursor: pointer; border:none; padding:10px; margin-left:5px; margin-right:5px;">Reload UNILOADER</button>
    </div>
  </div>
    <hr>
  <!-- ASTERISK INFO -->
  ...
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
        <h3>QUEUEMETRICS SERVICES</h3>
        <table class="w3-table w3-striped w3-white">
          <tr>
            <td><i class="fa fa-globe w3-text-black w3-large"></i></td>
            <td>QM Tomcat 6</td>
            <td><?php echo $qmRunning; ?></td>
          </tr>
          <tr>
            <td><i class="fa fa-id-card-o w3-text-black w3-large"></i></td>
            <td>Qloader</td>
            <td><?php echo $qloaderRunning; ?></td>
          </tr>
          <tr>
            <td><i class="fa fa-id-card w3-text-black w3-large"></i></td>
            <td>Uniloader</td>
            <td><?php echo $uniloaderRunning; ?></td>
          </tr>
        </table>
      </div>
    </div>
