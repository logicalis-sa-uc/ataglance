...
<hr>
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
        <h3>RUN COMMANDS</h3>
	    <button type="button" onclick="confirmReload('KAMAILIO');" class="w3-black" style="width:200px; border-radius: 10px; cursor: pointer; border:none; padding:10px; margin-left:5px; margin-right:5px;">Reload KAMAILIO</button>
    </div>
  </div>
    <hr>
  <!-- ASTERISK INFO -->
