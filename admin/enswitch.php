...
require_once "../configs/enswitch_vars.php";
?>
<!DOCTYPE html>
<html>
<head>
<title>LSA @ A GLANCE | ENSWITCH</title>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<script src="../scripts/sidebar.js"></script>
<script src="../scripts/enswitch_buttons.js"></script>
</head>
...
<nav class="w3-sidebar w3-collapse w3-animate-left" style="z-index:3;width:300px; background-color: <?php echo $bgColor; ?>; color: <?php echo $txtColor; ?>;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="enswitch.php" class="w3-bar-item w3-button w3-padding w3-red"<?php if ($enswitchEnabled != 1) echo ' style="display: none;"'; ?>><i class="fa fa-vcard-o fa-fw"></i> Enswitch</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h3><b><i class="fa fa-dashboard"></i> LSA ENSWITCH</b></h3>
  </header>
<hr>
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
    <h3>RUN COMMANDS</h3>
        <button type="button" onclick="confirmReload('NGINX');" class="w3-black" style="width:200px; border-radius: 10px; cursor: pointer; border:none; padding:10px; margin-left:5px; margin-right:5px;">Reload NGINX</button>
    </div>
  </div>
    <hr>
  <!-- ASTERISK INFO -->
  ...
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
        <h3>ENSWITCH SERVICES</h3>
        <table class="w3-table w3-striped w3-white">
          <tr>
            <td><i class="fa fa-globe w3-text-black w3-large"></i></td>
            <td>NGINX</td>
            <td><?php echo $nginxRunning; ?></td>
          </tr>
          <tr>
            <td><i class="fa fa-handshake-o w3-text-black w3-large"></i></td>
            <td>RPCBIND</td>
            <td><?php echo $rpcbindRunning; ?></td>
          </tr>
          <tr>
            <td><i class="fa fa-arrows w3-text-black w3-large"></i></td>
            <td>ENSWITCH ROUTE</td>
            <td><?php echo $enswitchroutRunning; ?></td>
          </tr>
          <tr>
            <td><i class="fa fa-comment w3-text-black w3-large"></i></td>
            <td>ENSWITCH MESSAGE</td>
            <td><?php echo $enswitchmessaRunning; ?></td>
          </tr>
          <tr>
            <td><i class="fa fa-phone w3-text-black w3-large"></i></td>
            <td>ENSWITCH SIPD</td>
            <td><?php echo $enswitchsipdRunning; ?></td>
          </tr>
          <tr>
            <td><i class="fa fa-cloud w3-text-black w3-large"></i></td>
            <td>RTP ENGINE</td>
            <td><?php echo $rtpengineRunning; ?></td>
          </tr>
        </table>
      </div>
    </div>
