...
require_once "../configs/freepbx_vars.php";
?>
<!DOCTYPE html>
<html>
<head>
<title>LSA @ A GLANCE | FREEPBX</title>
<meta charset="UTF-8">
...
<script src="../scripts/freepbx_buttons.js"></script>
</head>
...
<nav class="w3-sidebar w3-collapse w3-animate-left" style="z-index:3;width:300px; background-color: <?php echo $bgColor; ?>; color: <?php echo $txtColor; ?>;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="freepbx.php" class="w3-bar-item w3-button w3-padding w3-red"<?php if ($freepbxEnabled != 1) echo ' style="display: none;"'; ?>><i class="fa fa-phone fa-fw"></i> FreePBX</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h3><b><i class="fa fa-dashboard"></i> LSA FREEPBX</b></h3>
  </header>
<hr>
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
        <h3>RUN COMMANDS</h3>
	    <button type="button" onclick="confirmReload('HTTPD');" class="w3-black" style="width:200px; border-radius: 10px; cursor: pointer; border:none; padding:10px; margin-left:5px; margin-right:5px;">Reload HTTPD</button>
	    <button type="button" onclick="confirmReload('AMPORTAL');" class="w3-black" style="width:200px; border-radius: 10px; cursor: pointer; border:none; padding:10px; margin-left:5px; margin-right:5px;">Reload AMPORTAL</button>
	    <button type="button" onclick="confirmReload('FWCONSOLE');" class="w3-black" style="width:200px; border-radius: 10px; cursor: pointer; border:none; padding:10px; margin-left:5px; margin-right:5px;">Reload FWCONSOLE</button>
    </div>
  </div>
    <hr>
  <!-- ASTERISK INFO -->
  ...
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
        ...
        <table class="w3-table w3-striped w3-white">
          ...
          <tr>
            <td><i class="fa fa-internet-explorer w3-text-black w3-large"></i></td>
            <td>AMPORTAL</td>
            <td><?php echo $amportalRunning; ?></td>
          </tr>
          <tr>
            <td><i class="fa fa-edge w3-text-black w3-large"></i></td>
            <td>FWCONSOLE</td>
            <td><?php echo $fwconsoleRunning; ?></td>
          </tr>
        </table>
      </div>
    </div>
