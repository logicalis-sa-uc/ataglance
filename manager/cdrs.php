...
<nav class="w3-sidebar w3-collapse w3-animate-left" style="z-index:3;width:300px; background-color: <?php echo $bgColor; ?>; color: <?php echo $txtColor; ?>;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="cdrs.php" class="w3-bar-item w3-button w3-padding w3-red"<?php if ($cdrsEnabled != 1) echo ' style="display: none;"'; ?>><i class="fa fa-calendar fa-fw"></i> CDRs</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h3><b><i class="fa fa-dashboard"></i> LSA CDR's</b></h3>
  </header>
<hr>
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
        <h3>SEARCH NUMBER CDR's</h3>
        <form class="settingsForm" method="post" action='../exe/cdrSearchm.php'>
            <label for="startDate" name="startDate" id="startDate">Start Date:</label><br>
            <input type="date" name="startDate" required><br>
            <label for="startTime" name="startTime" id="startTime">Start Time:</label><br>
            <input type="time" name="startTime" required><br>
	    <label for="endDate" name="endDate" id="endDate">End Date:</label><br>
            <input type="date" name="endDate" required><br>
            <label for="endTime" name="endTime" id="endTime">End Time:</label><br>
            <input type="time" name="endTime" required><br>
            <label for="clid" name="clid" id="clid">Caller / Called Number:</label><br>
            <input type="text" name="clid"><br><br>
            <button type="submit" class="w3-black" style="width:200px; border:none; border-radius: 10px; padding:5px; cursor: pointer; margin-left:5px; margin-right:5px;">Search CDR's</button>
        </form>
    </div>
  <hr>
    <br>
