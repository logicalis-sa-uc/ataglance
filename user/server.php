  ...
  <hr>
    ...
    <div class="w3-row-padding" style="margin:0 -16px">
        ...
        <table class="w3-table w3-striped w3-white">
          ...
          <tr>
            <td><i class="fa fa-hdd-o w3-text-black w3-large"></i></td>
            <td><?php echo $partition1; ?></td>
            <td><i><?php echo $part1Total; ?></i></td>
            <td><i><?php echo $part1Used; ?></i></td>
            <td><i><?php echo $part1Free; ?></i></td>
          </tr>
          <tr>
            <td><i class="fa fa-hdd-o w3-text-black w3-large"></i></td>
            <td><?php echo $partition2; ?></td>
            <td><i><?php echo $part2Total; ?></i></td>
            <td><i><?php echo $part2Used; ?></i></td>
            <td><i><?php echo $part2Free; ?></i></td>
          </tr>
          <tr>
            <td><i class="fa fa-hdd-o w3-text-black w3-large"></i></td>
            <td><?php echo $partition3; ?></td>
            <td><i><?php echo $part3Total; ?></i></td>
            <td><i><?php echo $part3Used; ?></i></td>
            <td><i><?php echo $part3Free; ?></i></td>
          </tr>
          <tr>
            <td><i class="fa fa-hdd-o w3-text-black w3-large"></i></td>
            <td><?php echo $partition4; ?></td>
            <td><i><?php echo $part4Total; ?></i></td>
            <td><i><?php echo $part4Used; ?></i></td>
            <td><i><?php echo $part4Free; ?></i></td>
          </tr>
          <tr>
